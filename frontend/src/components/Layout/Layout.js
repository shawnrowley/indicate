          ...
          <Hammer onSwipe={this.handleSwipe}>
            <main className={s.content}>
              ...
              <TransitionGroup>
                ...
                >
                  <Switch>
                    ...
                    />
                    <Route
                      path="/app/charts/apex"
                      exact
                      component={ApexCharts}
                    />
                    <Route
                      path="/app/charts/echarts"
                      exact
                      component={Echarts}
                    />
                    <Route
              ...
              <footer className={s.contentFooter}>
                Indicate Dashboard - React admin made by{" "}
                <a href="https://shawnrowleyio.herokuapp.com">shawnRowley</a>
              </footer>
            </main>
          </Hammer>
        </div>
