      ...
      <div className="auth-page">
        <Container>
          ...
          >
            ...
            <Alert
              className="alert-sm text-center mt-2 widget-middle-overflow rounded-0"
              color="default"
            >
            ...
            <form onSubmit={this.doLogin}>
              ...
              <div className="bg-widget auth-widget-footer">
                ...
                <Link className="d-block text-center mt-2 fs-sm" to="forgot">
                  Forgot password?
                </Link>
        ...
        <footer className="auth-footer">
          {new Date().getFullYear()} &copy; Light Blue - React Admin Dashboard
          Template. Made by{" "}
          <a
