    ...
    return (
      <div className="root">
            ...
            <Widget refresh close bodyClass="mt-0">
              <div className="widget-top-overflow widget-padding-md clearfix bg-primary text-white">
                ...
                <ul className="tags text-white pull-right">
                  <li>
                    <button className="btn-link text-white">features</button>
                  </li>
                </ul>
              </div>
                    ...
                    <div className="comment-body">
                      <InputGroup size="sm">
                        ...
                        <InputGroupAddon addonType="append">
                          <Button color="subtle-blue">Send</Button>
                        </InputGroupAddon>
                      </InputGroup>
                    </div>
                  </li>
            ...
            <Widget refresh close bodyClass="mt-0">
              <div>
                <div className="widget-top-overflow text-white">
                  ...
                  <ul className="tags text-white pull-right">
                    <li>
                      <button className="btn-link text-white">design </button>
                    </li>
                    <li>
                      <button className="btn-link text-white"> white</button>
                    </li>
                  </ul>
                </div>
        ...
        <Row>
          ...
          <Col lg={4} xs={12}>
            <Widget className="bg-widget-transparent-dark text-white">
              <RealtimeTraffic />
            </Widget>
          </Col>
        </Row>
                ...
                <Slider {...settings} className={s.hideOverflow}>
                  <div className={s.slideWrap}>
                    ...
                    <div>
                      ...
                      <button
                        className={`${s.positionElementBottom} btn btn-primary btn-block mt`}
                      >
                        Order Now!
                      </button>
                    </div>
              ...
              <div className={s.flipCardInner}>
                <div className={s.flipCardFront}>
                  ...
                  >
                    ...
                    <h3 className="fw-normal">Indicate Web App</h3>
